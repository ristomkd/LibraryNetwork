...
namespace LibraryNetwork.Areas.Identity.Pages.Account
{
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var existingMember = await _db.Members.FirstOrDefaultAsync(m =>
                    ...
                    {
                        // Link the existing unlinked member to this account
                        existingMember.UserId = user.Id;
                        if (string.IsNullOrEmpty(existingMember.Email))
                            existingMember.Email = Input.Email;
                    }
                    else
                    {
                        ...
                        _db.Members.Add(existingMember);
                    }

                    await _db.SaveChangesAsync();

                    // Set the MemberId on the Identity user
